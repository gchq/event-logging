...
public final class DefaultXMLValidator implements XMLValidator {
    ...
    private static final event.logging.impl.ValidationExceptionBehaviourMode DEFAULT_VALIDATION_EXCEPTION_BEHAVIOUR_MODE = event.logging.impl.ValidationExceptionBehaviourMode.LOG;
    private final event.logging.impl.ValidationExceptionBehaviourMode validationExceptionBehaviourMode;

    public DefaultXMLValidator(final String schemaLocation) {
        // use the default of logging all validation messages
        this(schemaLocation, new event.logging.impl.LoggingErrorHandler(), DEFAULT_VALIDATION_EXCEPTION_BEHAVIOUR_MODE);
    ...
    public DefaultXMLValidator(final String schemaLocation, final ErrorHandler validationErrorHandler,
                               final event.logging.impl.ValidationExceptionBehaviourMode validationExceptionBehaviourMode) {
    ...
    private Schema loadSchema(final String schemaLocation) {
        ...
        try {
            ...
            final event.logging.impl.LoggingErrorHandler errorHandler = new LoggingErrorHandler();
