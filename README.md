...
Using your own implemtation that extends `DefaultEventLoggingService` is the preferred approach to dealing with common values in your events.
...
The documention for developers contributing to this library see [here](./docs/developing_this_lib.md).
