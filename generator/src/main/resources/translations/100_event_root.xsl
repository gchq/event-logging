...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:evt="event-logging:3" version="1.0">
    ...
    <xsl:template match="xs:schema">
        ...
        <xsl:copy>
            ...
            <xsl:apply-templates select="//xs:element[@name='Event']" mode="removeSomeAtts" />
